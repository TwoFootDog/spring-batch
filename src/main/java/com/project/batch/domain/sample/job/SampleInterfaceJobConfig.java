/*
 * @file : com.project.batch.domain.sample.job.SampleInterfaceJobConfig.java
...
import com.project.batch.domain.sample.tasklet.SampleInterfaceTasklet;
...
public class SampleInterfaceJobConfig {
    ...
    public SampleInterfaceJobConfig(JobBuilderFactory jobBuilderFactory,
                                    ...
                                    @Qualifier("firstDbTransactionManager") DataSourceTransactionManager transactionManager) {
