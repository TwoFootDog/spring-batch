/*
 * @file : com.project.batch.domain.sample.job.SampleExcelFileJobConfig.java
...
import com.project.batch.domain.sample.writer.SampleExcelFileWriter;
...
public class SampleExcelFileJobConfig {
    ...
    public SampleExcelFileJobConfig(JobBuilderFactory jobBuilderFactory,
                                    ...
                                    @Qualifier("firstDbTransactionManager") DataSourceTransactionManager pointTransacationManager) {
