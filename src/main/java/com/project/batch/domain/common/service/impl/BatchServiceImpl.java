/*
 * @file : com.project.batch.domain.common.service.BatchServiceImpl.java
...
public class BatchServiceImpl implements BatchService {
    ...
    public BatchServiceImpl(JobLauncher jobLauncher, JobLocator jobLocator, JobOperator jobOperator,
