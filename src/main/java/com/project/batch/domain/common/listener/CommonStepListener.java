/*
 * @file : com.project.batch.domain.common.listener.CommonStepListener.java
 * @desc : Spring Batch 의 Step 메인 로직 실행 전/후 처리를 수행하는 리스너
 * @auth :
 * @version : 1.0
 * @history
...
package com.project.batch.domain.common.listener;
...
public class CommonStepListener implements StepExecutionListener {
    ...
    /*
     * @method : beforeStep
     * @desc : Spring Batch Step 메인 로직 시작 전 실행
     * @param :
     * @return :
     * */
    @Override
    ...
    /*
     * @method : afterStep
     * @desc : Spring Batch Step 완료 전 실행
     * @param :
