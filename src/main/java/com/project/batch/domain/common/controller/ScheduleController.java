/*
 * @file : com.project.batch.domain.common.controller.ScheduleController.java
...
import com.project.batch.domain.common.service.ScheduleService;
...
public class ScheduleController {
     ...
     * */
    @PutMapping
    public ScheduleResponseDto updateJobSchedule(
     ...
     * */
    @DeleteMapping
    public ScheduleResponseDto deleteJobSchedule(
                                    @RequestParam("jobName") String jobName,
                                    @RequestParam("jobGroup") String jobGroup) {
     ...
     * */
    @GetMapping("/start")
    public ScheduleResponseDto startJobSchedule(
                                    @RequestParam("jobName") String jobName,
                                   @RequestParam("jobGroup") String jobGroup) {
     ...
     * */
    @GetMapping("/stop")
    public ScheduleResponseDto stopJobSchedule(
                                    @RequestParam("jobName") String jobName,
                                    @RequestParam("jobGroup") String jobGroup) {
     ...
     * */
    @GetMapping("/resume")
    public ScheduleResponseDto resumeJobSchedule(
                                    @RequestParam("jobName") String jobName,
                                    @RequestParam("jobGroup") String jobGroup) {
