/*
 * @file : com.project.batch.domain.common.service.ScheduleServiceImpl.java
...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    public ScheduleServiceImpl(Scheduler scheduler, JobLauncher jobLauncher, JobLocator jobLocator,
