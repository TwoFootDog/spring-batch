...
@Configuration
@Data
public class Sample3QuartzConfig {
    private final static Logger logger = LogManager.getLogger(Sample3QuartzConfig.class);
    ...
    @Bean(name = "sample3JobDetail")
    public JobDetailFactoryBean jobDetailFactoryBean() {
        JobDetailFactoryBean factoryBean = new JobDetailFactoryBean();
        factoryBean.setJobClass(Sample3QuartzJob.class);
        Map<String, Object> map = new HashMap<>();
        map.put("jobName", "sampleJob3");
