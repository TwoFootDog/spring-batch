        ...
        try {
            ...
            if (!scheduler.checkExists(jobDetail.getKey())) {
                ...
                return new ScheduleResponseDto
                        .Builder()
                        .resultCode(messageSource.getMessage("schedule.response.fail.code", new String[]{}, null))
                        .resultMessage(messageSource.getMessage("schedule.response.fail.msg", new String[]{"Job Schedule Already Exist"}, null))
                        .build();
            }
        ...
        try {
            ...
            if (result) {
                ...
                return new ScheduleResponseDto
                        .Builder()
                        .resultCode(messageSource.getMessage("schedule.response.fail.code", new String[]{}, null))
                        .resultMessage(messageSource.getMessage("schedule.response.fail.msg", new String[]{"Delete target not found"}, null))
                        .build();
            }
        } catch (SchedulerException e) {
